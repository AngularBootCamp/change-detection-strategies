# DRAFT - Angular Boot Camp Curriculum - change-detection-strategies
...
[StackBlitz for change-detection-strategies](https://stackblitz.io/github/AngularBootCamp/change-detection-strategies)

Alternatively, you can clone the repository locally and run the
following commands:

```
git clone git@github.com:AngularBootCamp/change-detection-strategies.git
cd change-detection-strategies
yarn
yarn start
```
